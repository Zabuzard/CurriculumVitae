...
\cvjobtitle{Software Engineer, 30} % Job
...
\cvgithubRepos{61} % GitHub amount of repositories
\cvgithubForks{34} % GitHub amount of forks
\cvgithubStars{153} % GitHub amount of stars
...
\cvstackoverflowRep{23,988} % StackOverflow user reputation
\cvstackoverflowGold{7} % StackOverflow amount of gold badges
\cvstackoverflowSilver{56} % StackOverflow amount of silver badges
\cvstackoverflowBronze{78} % StackOverflow amount of bronze badges
...
\technologies{
	...
	{materialamber!20/Organization/GitLab Issues, Jira, Confluence, Redmine, Mantis, Toggl, Grafana, Kibana, SmartRecruiters, KeePass, ISO 9001},
