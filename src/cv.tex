...
\cvgithubRepos{58} % GitHub amount of repositories
\cvgithubForks{24} % GitHub amount of forks
\cvgithubStars{134} % GitHub amount of stars
...
\cvstackoverflowRep{20,802} % StackOverflow user reputation
\cvstackoverflowGold{7} % StackOverflow amount of gold badges
\cvstackoverflowSilver{45} % StackOverflow amount of silver badges
\cvstackoverflowBronze{67} % StackOverflow amount of bronze badges
