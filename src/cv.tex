...
\begin{twenty} % Environment for a list with descriptions
	...
	\twentyitem
		...
		{Nov 2019}
        		...
        		{Java 9, Maven}
        		{\begin{itemize}
        			\item Sophisticated and customizable library for solving various shortest path problems using Module-Dijkstra, ALT and A*
        		\end{itemize}}\\
	\twentyitem
    		{Nov 2019 -}
		{Nov 2019}
        		...
        		{\begin{itemize}
        			\item Compact library for nearest neighbor computation based on Cover Trees
        		\end{itemize}}\\
	\twentyitem
    		{Apr 2018 -}
		{Aug 2018}
...
\begin{twenty}
	...
	\twentyitem
		...
		{Oct 2017}
        		...
        		{\begin{itemize}
        			\item Creation of a robust Selenium driven semi-automatic bot that trades items in a browser embedded MMORPG with other players
        		\end{itemize}}\\
	\twentyitem
    		{May 2017 -}
		{Aug 2017}
	...
	\twentyitem
		...
		{Jul 2017}
        		...
        		{\begin{itemize}
        			\item Information Retrieval library based on inverted indices, q-grams and BM-25 ranking
