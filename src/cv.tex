...
\cvstackoverflowRep{8,926} % StackOverflow user reputation
\cvstackoverflowGold{3} % StackOverflow amount of gold badges
\cvstackoverflowSilver{20} % StackOverflow amount of silver badges
\cvstackoverflowBronze{37} % StackOverflow amount of bronze badges
	...
	\twentyitem
		...
		{Aug 2017}
        		...
        		{\begin{itemize}
        			...
        			\item Creation of a demo GUI that step wise shows how the algorithm works, present the algorithm on a conference
        		\end{itemize}}\\
	%\twentyitem{<dates>}{<title>}{<location>}{<description>}
\end{twenty}
