...
\cvgithubRepos{59} % GitHub amount of repositories
\cvgithubForks{29} % GitHub amount of forks
\cvgithubStars{137} % GitHub amount of stars
...
\cvstackoverflowRep{22,296} % StackOverflow user reputation
\cvstackoverflowGold{7} % StackOverflow amount of gold badges
\cvstackoverflowSilver{49} % StackOverflow amount of silver badges
\cvstackoverflowBronze{73} % StackOverflow amount of bronze badges
...
% Technologies
\technologies{
	{materialteal!35/Java/Gson, Jackson, Selenium, JSoup, HttpComponents, Swing, JBoss Drools,\vspace{1mm}\\
		JUnit, Mockito, Logback, SLF4J, Log4j,\vspace{1mm}\\
	...
	{materialteal!35/Databases/MySQL, SQLite, InfluxDB, NoSQL, H2, MariaDB, PostgreSQL, Oracle DB, Flyway, jOOQ},
	...
	{materialamber!20/Build Management/Maven, Gradle, CMake, Conan, Ant, Jenkins, docker, jib, SonarQube, Resharper, Checkstyle, Spotless},
