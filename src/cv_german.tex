...
\cvstackoverflowRep{9,404} % StackOverflow user reputation
\cvstackoverflowGold{4} % StackOverflow amount of gold badges
\cvstackoverflowSilver{22} % StackOverflow amount of silver badges
